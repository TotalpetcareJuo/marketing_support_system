// ------------------------------------
// Slideshow Templates Module
// Static slide markup builders
// ------------------------------------

// Helper: Render checklist items for pet cards
function renderChecklist(items, isHero) {
...
// Helper: Create hero card (full-width pet card)
function createHeroCard(pet) {
    return `
...
// Helper: Create standard pet card
function createStandardCard(pet) {
    return `
...
// Template: Slide 1 - Premium Hero
function getSlide1PremiumHero() {
    return `
...
// Template: Slide 2 - Notice (if enabled)
function getSlide2Notice(slideIndex) {
    return `
...
// Template: Slide 3 - Pet Insurance
function getSlide3PetInsurance() {
    return `
        <style>
...
// Template: Slide 4 - Bridge 1 (Donut Chart)
function getSlide4BridgeDonutChart() {
    return `
        <style>
...
// Template: Slide 5 - Bridge 2 (Puzzle: Pet Insurance -> Membership)
function getSlide5BridgePuzzle() {
    return `
        <style>
            @keyframes spin-slow {
...
// Template: Slide 6-A - White & Silver Membership
function getSlide6MembershipSilver() {
    return `
        <style>
...
// Template: Slide 6-B - Gold & VIP Membership
function getSlide6MembershipGoldVip(isShelterMode) {
...
// Template: Slide 8 - Closing / CTA
function getSlide8ClosingCta() {
    return `
